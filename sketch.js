...
function draw() 
{
    ...
    //checks if the arc has collided the shapes or the ground
    if(gameState===lvl1||gameState===lvl2||gameState===lvl3){
      ...
      if(inviSprite1.isTouching(obstaclesGroup2)||inviSprite2.isTouching(obstaclesGroup2))
      {
        gameState="end";
      }
      if(inviSprite1.isTouching(obstaclesGroup3)||inviSprite2.isTouching(obstaclesGroup3))
      {
        gameState="end";
      }
    }
